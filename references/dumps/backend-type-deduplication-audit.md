...
**Medium:**
4. `Indexed*` types in `indexer/types.ts` — consistent pattern: schema inference + explicit table column picks

**Low (consider last):**
5. Fix `ProjectUpdateSchema` drift (missing `currentFragmentUUID`) as part of Phase 5
