...
**Status**: accepted — refines `references/adr/0007-margin-anchored-comments-supersede-file-based-comments.md` (the data model) with the interaction/layout model; supersedes the "CM6/vim marker rendering: reveal-on-block-cursor" prior decision in `specifications/margins.md`
