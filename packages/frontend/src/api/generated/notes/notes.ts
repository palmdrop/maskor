...
>(
  projectId: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof ListNotes>>, TError, TData>>;
...
export const getCreateNoteMutationOptions = <TError = ErrorResponse, TContext = unknown>(options?: {
 ...
 * @summary Create a new note in the vault
 */
export const useCreateNote = <TError = ErrorResponse, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof CreateNote>>,
      TError,
...
export const getGetNoteUrl = (projectId: string, noteId: string) => {
...
export const getGetNoteQueryKey = (projectId: string, noteId: string) => {
  return [`/projects/${projectId}/notes/${noteId}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof GetNote>>> = ({ signal }) =>
    GetNote(projectId, noteId, { signal, ...requestOptions });
...
export const getDeleteNoteUrl = (projectId: string, noteId: string) => {
  return `/projects/${projectId}/notes/${noteId}`;
};
...
export const getDeleteNoteMutationOptions = <TError = ErrorResponse, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
 ...
 * @summary Delete a note from the vault
 */
export const useDeleteNote = <TError = ErrorResponse, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof DeleteNote>>,
      TError,
