...
import { ACTION_LOG_DIRNAME, ACTION_LOG_FILENAME, DEFAULT_ROTATION_THRESHOLD } from "./constants";
...
export const createActionLogWriter = async (config: ActionLogConfig): Promise<ActionLogWriter> => {
