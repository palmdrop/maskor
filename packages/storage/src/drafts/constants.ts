...
export const SNAPSHOT_VAULT_DIRECTORIES = ["fragments", "aspects", "notes", "references"] as const;
...
export const RESTORE_VAULT_DIRECTORIES = ["fragments", "aspects", "notes", "references"] as const;
