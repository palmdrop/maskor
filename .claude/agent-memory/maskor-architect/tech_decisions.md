...
**How to apply:** Check here before suggesting a technology. Don't re-propose rejected or settled choices.
...
- API framework: Hono listed in CLAUDE.md, not yet installed. NestJS mentioned in TODO. Hono is correct call (lightweight, Bun-native).
...
- Import: Pandoc for .docx — not yet wired
...
- execa → Bun.$`cmd`
- jest/vitest → bun test (except frontend)
